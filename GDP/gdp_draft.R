...
start_Q = 4
  ...
  rm(list=setdiff(ls(), c( "horizont", "h", "Selected_diff", "gdpdfFull", "quarterlyFull", "quarterlyts", "d",
                           "gdp_d", "work_data_diff", "work_data_diff_ts", "Final_Results", "testres")))
  
}

testres
testres2 = Final_Results[c('MSE1', 'TheilU1', 'MSE2', 'TheilU2', 'MSE4', 'TheilU4', 'MSE8', 'TheilU8')]
rm(list=setdiff(ls(), "testres"))
...
dm.test(adl_gamboost_forecast[,5], adl_gamboost_forecast[,3], h=h, power=2) # {forecast} built-in method
