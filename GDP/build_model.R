p = 6 # it is p-1 in fact

adl_predictors = names(work_data_diff[,-1])
adl_formula = as.formula(paste("logGDP ~ L(logGDP,", h,":", h+p, ") +", 
                               paste("L(", adl_predictors, ",", h,":", h+p, ")", 
                                     sep = '', 
                                     collapse = "+") ))
...
adl_formula_test = as.formula(paste("logGDP ~ L(logGDP, ", 0,":", p, ") +", 
                                    paste("L(", adl_predictors, ",", 0,":", p, ")", 
                                          sep = '', 
                                          collapse = "+") ))
